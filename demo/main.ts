...
const globe = document.getElementById('globe') as GlobeChart;
...
const saved = (localStorage.getItem('globe-chart-demo-theme') as 'light' | 'dark' | null) ?? 'light';
applyTheme(saved);
